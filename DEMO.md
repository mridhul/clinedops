...
On first backend startup (Docker), the same demo data is applied automatically if the database is empty. Set `AUTO_SEED_DEMO=0` on the backend service to disable.
