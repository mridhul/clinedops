...
class ManualSurveyAssignmentCreate(BaseModel):
    template_id: UUID
    student_ids: List[UUID]
    tutor_ids: Optional[List[UUID]] = Field(default_factory=list)
    posting_id: Optional[UUID] = None
    session_ids: Optional[List[UUID]] = Field(default_factory=list)
